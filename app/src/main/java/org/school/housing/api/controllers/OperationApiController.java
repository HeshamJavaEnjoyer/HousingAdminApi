...
public class OperationApiController extends ApiBaseController {
    ...
    public void updateOperation(int op_id,String category_id, String amount, String details, String actor_id, String actor_type, String date, ProcessCallback processCallback) {
        Log.d(TAG, "updateOperation() called with: op_id = [" + op_id + "], category_id = [" + category_id + "], amount = [" + amount + "], details = [" + details + "], actor_id = [" + actor_id + "], actor_type = [" + actor_type + "], date = [" + date + "], processCallback = [" + processCallback + "]");
        HashMap<String, RequestBody> map = new HashMap<>();
        ...
        map.put("amount", RequestBody.create(MediaType.parse("text/plain"), amount));
        map.put("details", RequestBody.create(MediaType.parse("text/plain"), details));
        map.put("actor_type", RequestBody.create(MediaType.parse("text/plain"), actor_type));
        map.put("date", RequestBody.create(MediaType.parse("text/plain"), date));
        map.put("category_id", RequestBody.create(MediaType.parse("text/plain"), category_id));
